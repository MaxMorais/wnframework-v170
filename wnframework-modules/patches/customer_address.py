...
def sync_docfield_properties():
	update_fields = [	
	('Contact', 'customer', 'Customer', 0, None, 0, None), ('Contact', 'supplier', 'Supplier', 0, None, None, None), ('Contact', 'is_primary_contact', None, 0, None, None, None), ('Contact', 'email_id', None, 0, 1, None, None), ('Contact', 'department', 'Suggest', 0, None, None, None), ('Contact', 'designation', 'Suggest', 0, None, None, None),
	('Customer Issue', 'customer', 'Customer', 0, 1, 1, None), ('Customer Issue', 'customer_address', 'Address', 0, None, 1, None), ('Customer Issue', 'contact_person', 'Contact', 0, None, 1, None), ('Customer Issue', 'customer_name', None, 1, None, None, None), ('Customer Issue', 'company', 'Company', 0, 1, 1, None), ('Customer Issue', 'fiscal_year', 'link:Fiscal Year', 0, 1, 1, None),
	('Delivery Note', 'customer_address', 'Address', 0, None, 1, None), ('Delivery Note', 'contact_person', 'Contact', 0, None, 1, None), ('Delivery Note', 'customer_name', None, 1, None, None, None), ('Delivery Note', 'status', '\nDraft\nSubmitted\nCancelled', 1, 1, 1, None), ('Delivery Note', 'territory', 'Territory', 0, 1, 1, 0), ('Delivery Note', 'customer_group', 'Customer Group', 0, None, 1, None), ('Delivery Note', 'transporter_name', None, 0, 0, 1, None), ('Delivery Note', 'lr_no', None, 0, 0, 1, None), ('Delivery Note', 'lr_date', None, 0, None, 1, None), ('Delivery Note', 'currency', 'link:Currency', 0, 1, 1, None), ('Delivery Note', 'letter_head', 'link:Letter Head', 0, None, 1, None),
	('Enquiry', 'contact_person', 'Contact', 0, None, 1, None), ('Enquiry', 'customer_name', None, 1, None, 0, None), ('Enquiry', 'lead', 'Lead', 0, None, 1, 0), ('Enquiry', 'enquiry_type', '\nSales\nMaintenance', 0, 1, None, None), ('Enquiry', 'territory', 'Territory', 0, 1, 1, None), ('Enquiry', 'customer_group', 'Customer Group', 0, 0, 1, 0), ('Enquiry', 'contact_by', 'Profile', 0, None, None, None),
	('Installation Note', 'contact_person', 'Contact', 0, None, 1, None), ('Installation Note', 'customer_name', None, 1, 0, None, None), ('Installation Note', 'territory', 'Territory', 0, 1, 1, None), ('Installation Note', 'status', 'Draft\nSubmitted\nCancelled', 1, 1, 1, None),
	('Lead', 'city', None, 0, 1, 1, None), ('Lead', 'country', 'link:Country', 0, 1, 1, None), ('Lead', 'state', 'Suggest', 0, None, 1, None), ('Lead', 'company', 'Company', 0, 1, None, None), ('Lead', 'contact_by', 'Profile', 0, 0, 0, 0),
	('Maintenance Schedule', 'customer', 'Customer', 0, 1, 1, None), ('Maintenance Schedule', 'contact_person', 'Contact', 0, None, 1, None), ('Maintenance Schedule', 'status', '\nDraft\nSubmitted\nCancelled', 1, 1, None, None), ('Maintenance Schedule', 'territory', 'Territory', 0, 1, None, None),
	('Maintenance Visit', 'customer', 'Customer', 0, 1, 1, None), ('Maintenance Visit', 'contact_person', 'Contact', 0, None, 1, None), ('Maintenance Visit', 'customer_name', None, 1, None, None, None), ('Maintenance Visit', 'company', 'link:Company', 0, 1, 1, None), ('Maintenance Visit', 'fiscal_year', 'link:Fiscal Year', 0, 1, 1, None), ('Maintenance Visit', 'status', '\nDraft\nCancelled\nSubmitted', 1, 1, None, None), ('Maintenance Visit', 'territory', 'Territory', 0, None, 1, None),
	('Purchase Order', 'supplier_address', 'Address', 0, None, 1, None), ('Purchase Order', 'contact_person', 'Contact', 0, None, 1, None), ('Purchase Order', 'supplier_name', None, 1, None, None, None), ('Purchase Order', 'status', '\nDraft\nSubmitted\nStopped\nCancelled', 1, 1, 1, None), ('Purchase Order', 'indent_no', 'Indent', 0, None, 1, 0), ('Purchase Order', 'is_subcontracted', '\nYes\nNo', 0, None, 1, None), ('Purchase Order', 'currency', 'link:Currency', 0, 1, 1, None), ('Purchase Order', 'net_total', None, 1, 0, 1, None),
	('Purchase Receipt', 'supplier_address', 'Address', 0, None, 1, None), ('Purchase Receipt', 'contact_person', 'Contact', 0, None, 1, None), ('Purchase Receipt', 'supplier_name', None, 1, None, None, None), ('Purchase Receipt', 'status', '\nDraft\nSubmitted\nCancelled', 1, 1, 1, None), ('Purchase Receipt', 'currency', 'link:Currency', 0, 1, 1, None),
	('Quotation', 'customer', 'Customer', 0, None, 1, 0), ('Quotation', 'customer_address', 'Address', 0, None, 1, 0), ('Quotation', 'contact_person', 'Contact', 0, 0, 1, 0), ('Quotation', 'customer_name', None, 1, None, None, None), ('Quotation', 'lead', 'Lead', 0, None, 1, 0), ('Quotation', 'lead_name', None, 1, None, None, None), ('Quotation', 'order_type', '\nSales\nMaintenance', 0, 1, 0, None), ('Quotation', 'status', '\nDraft\nSubmitted\nOrder Confirmed\nOrder Lost\nCancelled', 1, 1, 1, None), ('Quotation', 'territory', 'Territory', 0, 1, 1, 0), ('Quotation', 'currency', 'link:Currency', 0, 1, 1, None), ('Quotation', 'letter_head', 'link:Letter Head', 0, None, 1, None), ('Quotation', 'order_lost_reason', None, 1, None, 1, None), ('Quotation', 'contact_by', 'Profile', 0, None, 1, None), ('Quotation', 'contact_date', None, 0, None, 1, None), ('Quotation', 'to_discuss', None, 0, None, 1, None),
	('Receivable Voucher', 'debit_to', 'Account', 0, 1, 1, None), ('Receivable Voucher', 'customer_address', 'Address', 0, None, 1, None), ('Receivable Voucher', 'territory', 'Territory', 0, 1, 1, None), ('Receivable Voucher', 'paid_amount', None, 0, None, 1, None), ('Receivable Voucher', 'company', 'Company', 0, 1, 1, None), ('Receivable Voucher', 'fiscal_year', 'link:Fiscal Year', 0, 1, 1, None), ('Receivable Voucher', 'outstanding_amount', None, 1, None, 1, None),
	('Payable Voucher', 'supplier_address', 'Address', 0, None, 1, None), ('Payable Voucher', 'contact_display', None, 1, None, None, None), ('Payable Voucher', 'contact_mobile', None, 1, None, None, None), ('Payable Voucher', 'contact_email', None, 1, None, 1, None), ('Payable Voucher', 'currency', 'link:Currency', 0, 1, 1, None), ('Payable Voucher', 'conversion_rate', None, 0, 1, 1, None), ('Payable Voucher', 'company', 'Company', 0, 1, 1, None), ('Payable Voucher', 'fiscal_year', 'link:Fiscal Year', 0, 1, 1, None),
	('Sales Order', 'customer_address', 'Address', 0, None, 1, 0), ('Sales Order', 'contact_person', 'Contact', 0, None, 1, None), ('Sales Order', 'customer_name', None, 1, None, None, None), ('Sales Order', 'status', '\nDraft\nSubmitted\nStopped\nCancelled', 1, 1, 1, None), ('Sales Order', 'quotation_date', None, 1, 0, 1, 1), ('Sales Order', 'currency', 'link:Currency', 0, 1, 1, None), ('Sales Order', 'letter_head', 'link:Letter Head', 0, None, 1, None),
	('Sales Partner', 'territory', 'Territory', 0, 1, None, None),
	('Supplier', 'company', 'Company', 0, 1, None, None)]
