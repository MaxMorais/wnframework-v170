...
#
default_db_name = os.environ.get('MYSQL_DB_NAME', '/home/tmx-dev-05/Downloads/wn/test.db')
...
#
modules_path = os.environ.get('WNFRAMEWORK_MODULES_PATH', os.path.join(os.path.dirname(__file__), '../../../../wnframework-modules/'))
...
#
developer_mode = os.environ.get('WNFRAMEWORK_DEVELOPER_MODE', 0)

#
# Time Zone: Useful if your users are across timezones
#
user_timezone = os.environ.get('WNFRAMEWORK_TIMEZONE', 'America/Sao_Paulo')
